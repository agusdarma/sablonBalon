...
<html>
<head>
<title>Roasting a Hotel and Restaurant Category Flat Bootstrap Responsive website Template | Home</title>
<!---->
			...
			<div class="container">
				...
				<div class="best-grids">
					<div class="col-md-4 best-grid1">
						<img src="<s:url value='/Resource/roasting/images/cook.jpg'/>" class="img-responsive gray" alt=""/>
					</div>
			...
			<div class="container">
				...
				<div class="special-grids">
					<div class="col-md-4 menu-grid">
						<div class="menu1">
							<img src="<s:url value='/Resource/roasting/images/m1.jpg'/>" class="img-responsive gray" alt=""/>
					...
					<div class="col-md-4 menu-grid">
						<div class="menu1">
							<img src="<s:url value='/Resource/roasting/images/m2.jpg'/>" class="img-responsive gray" alt=""/>
							<div class="menu-icon hvr-sweep-to-top">
								<i class="glyphicon glyphicon-cutlery" aria-hidden="true"></i>
							</div>
						</div>
					...
					<div class="col-md-4 menu-grid">
						<div class="menu1">
							<img src="<s:url value='/Resource/roasting/images/m3.jpg'/>" class="img-responsive gray" alt=""/>
							<div class="menu-icon hvr-sweep-to-top">
								<i class="glyphicon glyphicon-filter" aria-hidden="true"></i>
							</div>
						</div>
				...
				<div class="special-grids">
					<div class="col-md-4 menu-grid">
						<div class="menu1">
							<img src="<s:url value='/Resource/roasting/images/m4.jpg'/>" class="img-responsive gray" alt=""/>
							<div class="menu-icon hvr-sweep-to-top">
								<i class="glyphicon glyphicon-headphones" aria-hidden="true"></i>
							</div>
						</div>
					...
					<div class="col-md-4 menu-grid">
						<div class="menu1">
							<img src="<s:url value='/Resource/roasting/images/m5.jpg'/>" class="img-responsive gray" alt=""/>
							<div class="menu-icon hvr-sweep-to-top">
								<i class="glyphicon glyphicon-time" aria-hidden="true"></i>
							</div>
						</div>
