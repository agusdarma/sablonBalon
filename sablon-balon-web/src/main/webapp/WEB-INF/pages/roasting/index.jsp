...
<link rel="shortcut icon" href="<s:url value='/Resource/roasting/images/favicon.ico'/>" type="image/x-icon">
<link rel="icon" href="<s:url value='/Resource/roasting/images/favicon.ico'/>" type="image/x-icon">
<!--for-mobile-apps-->
