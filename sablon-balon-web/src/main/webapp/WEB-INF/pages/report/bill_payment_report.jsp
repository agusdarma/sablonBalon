...
<html>
	<head>
		...
		<title><s:text name="t.report" /> | <s:text name="t.billPaymentReport" /></title>
		
		<!-- JAVA SCRIPT -->
		<s:url var="remoteurl" action="BillPaymentReport!processSearch"/>
	...
	<body>
        ...
        <main>
        	...
        	<hgroup class="ContainerInlineBlock">
            	<h1><s:text name="t.report" /> | <s:text name="t.billPayment" /></h1>
                <h2><s:text name="t.billPaymentReport.description" /></h2>
            </hgroup>
                ...
                <s:form id="formSearch">
                	...
                	<fieldset>
                        ...
                        <div class="FieldSetContainer">
							...
							<br>
							<label for="startDate"><s:text name="l.category"/></label>
							 <s:select id="category" name="paramVO.category" list="listBillPaymentCategory" 
