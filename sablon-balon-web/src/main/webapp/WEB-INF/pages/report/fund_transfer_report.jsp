...
<html>
	<head>
		...
		<title><s:text name="t.report" /> | <s:text name="t.fundTransfer" /></title>
		
		<!-- JAVA SCRIPT -->
		<s:url var="remoteurl" action="FundTransferReport!processSearch"/>
	...
	<body>
        ...
        <main>
        	...
        	<hgroup class="ContainerInlineBlock">
                ...
                <h2><s:text name="t.fundTransfer.description" /></h2>
            </hgroup>
            ...
            <section class="ContainerBlock">
                ...
                <s:form id="formSearch">
            		...
            		<!-- FORM -->
                	<fieldset>
                    	<legend><s:text name="d.fundTransfer"/></legend>
                        ...
                        <div class="FieldSetContainer">
							...
							<br>
                            <label for="deviceCode"><s:text name="l.destinationBank"/></label>
                            <s:select id="listTrxType" name="paramVO.bankCode" headerKey="-1" headerValue="All"  
								list="listBank" listValue="bankName" listKey="bankCode" cssClass="DropDown"/>
