...
<html>
	<head>
		...
		<title><s:text name="t.report" /> | <s:text name="t.cif" /></title>
	...
	<body>
        ...
        <main>
        	...
        	<hgroup class="ContainerInlineBlock">
            	<h1><s:text name="t.report" /> | <s:text name="t.cifReport" /></h1>
                <h2><s:text name="t.cifReport.description" /></h2>
            </hgroup>
            ...
            <section class="ContainerBlock">
            	...
            	<div class="PaperHeaderGroup">
            		<s:url id="search" action="CifReport!gotoSearch" includeParams="none"/>
                ...
                <s:form id="form1" >
            		...
            		<!-- FORM -->
                	<fieldset>
                    	<legend><s:text name="d.cifReport"/></legend>
                        <div class="ShapeTailBorder"></div>
                        <div class="ShapeTailBody"></div>
                        <div class="FieldSetContainer">
							<label for="userCode"><s:text name="l.userCode" /></label>		
							<s:textfield type="text" id="userCode" name="userActivity.userCode" cssClass="Property" />

							<br> 
							<label for="activity"><s:text name="l.activity" /></label>		
							<s:textfield type="text" id="activity" name="userActivity.action" cssClass="Property" />
							
							<br> 
							<label for="moduleName"><s:text name="l.moduleName" /></label>		
							<s:textfield type="text" id="moduleName" name="userActivity.moduleName" cssClass="Property" />
							
							<br> 
							<label for="targetTable"><s:text name="l.targetTable" /></label>		
							<s:textfield type="text" id="targetTable" name="userActivity.targetTable" cssClass="Property" />
							
							<br> 
							<label for="targetId"><s:text name="l.targetId" /></label>		
							<s:textfield type="text" id="targetId" name="userActivity.targetId" cssClass="Property" />
                        </div>
                    </fieldset>
