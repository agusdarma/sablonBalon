...
<html>
	<head>
		...
		<title><s:text name="t.report" /> | <s:text name="t.auditTrailAccount" /></title>
		
		<!-- JAVA SCRIPT -->
		<s:url var="remoteurl" action="AuditTrailAccount!processSearch"/>
	...
	<body>
        ...
        <main>
        	...
        	<hgroup class="ContainerInlineBlock">
            	<h1><s:text name="t.report" /> | <s:text name="d.auditTrailAccount" /></h1>
                <h2><s:text name="t.auditTrailAccount.description" /></h2>
            </hgroup>
            ...
            <section class="ContainerBlock">
                ...
                <s:form id="formSearch">
            		...
            		<!-- FORM -->
                	<fieldset>
                    	<legend><s:text name="d.auditTrailAccount"/></legend>
                        ...
                        <div class="FieldSetContainer">
							...
							<br>
                            <label for="accountNo"><s:text name="l.accountNumber" /></label>
							<s:textfield id="accountNo" name="paramVO.accountNo" cssClass="SingleLine" />
