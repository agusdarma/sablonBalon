...
<html>
	<head>
		...
		<title><s:text name="t.report" /> | <s:text name="t.matmPurchase" /></title>
		
		<!-- JAVA SCRIPT -->
		<s:url var="remoteurl" action="MatmPurchaseReport!processSearch"/>
	...
	<body>
        ...
        <main>
        	...
        	<hgroup class="ContainerInlineBlock">
            	<h1><s:text name="t.report" /> | <s:text name="t.matmPurchase" /></h1>
                <h2><s:text name="t.matmPurchase.description" /></h2>
            </hgroup>
            ...
            <section class="ContainerBlock">
                ...
                <s:form id="formSearch">
            		...
            		<!-- FORM -->
                	<fieldset>
                    	<legend><s:text name="d.matmPurchase"/></legend>
                        <div class="ShapeTailBorder"></div>
                        <div class="ShapeTailBody"></div>
                        <s:actionerror /><s:actionmessage />
                        <div class="FieldSetContainer">
                        	<%@ include file="/WEB-INF/includes/param_export.jsp" %>
                            <label for="deviceCode"><s:text name="l.merchantName"/></label>
                            <s:textfield id="deviceCode" name="paramVO.merchantName" cssClass="SingleLine"/>
							...
							<br>
                            <label for="listTrxType"><s:text name="l.trxStatus" /></label>
